...
// Execute query... 
    String buscar = "SELECT * FROM agencia WHERE codage = '" + codage + "'";
                                        ...
                                        <div class="table-wrapper">
                                            <div class="table-title">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <form action="buscaCambiaAgencia.jsp" method="GET"> 
                                                        <div class="form-group col-md-3 ">
                                                            <label>Código Agencia</label>
                                                            <input type="text" class="form-control" disabled  value="<%=codage%>">
                                                            <input type="hidden" class="form-control" name="codage" value="<%=codage%>">
                                                        </div>
                                                        <div class="form-group col-md-3 ">
                                                            <label>Nombre Agencia</label>
                                                            <input type="text" class="form-control" required name="nomage" value="<%=listado.getString("nomage")%>">
                                                        </div>
                                                        <div class="col-md-1">
                                                        <label>Acción</label>
