                                                    ...
                                                    <table class="table table-striped table-hover">
                                                        ...
                                                        <thead>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>Modificar Agencia</th>
                                                                <th>Borrar Agencia</th>
                                                                <th></th>
                                                        ...
                                                        <tbody>     
                                                            ...
                                                            <%    Class.forName("com.mysql.jdbc.Driver");
                                                                ...
                                                                ResultSet listado = s.executeQuery("SELECT * FROM agencia ORDER BY codage");
                                                                ...
                                                                while (listado.next()) {
                                                                    ...
                                                                    out.print("<td>");
                                                        %> 
                                                    <a href="cambiaAgencia.jsp?codage=<%= listado.getString("codage")%>"><i class="fa fa-edit"></i></a>
                                                        <%
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                        %> 

                                                    <a href="eliminaAgencia.jsp?codage=<%= listado.getString("codage")%>"><i class="fa fa-trash" onclick="myFunction()"></i></a>
