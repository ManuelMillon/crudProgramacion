...
// Execute query... 
    String buscar = "SELECT * FROM cliente WHERE codcli = '" + codcli + "'";
                                        ...
                                        <div class="table-wrapper">
                                            <div class="table-title">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <form action="buscaAlterCliente.jsp" method="GET"> 
                                                        <div class="form-group col-md-3 ">
                                                            <label>ID Cliente</label>
                                                            <input type="text" class="form-control" disabled  value=" <%=codcli%>">
                                                            <input type="hidden" class="form-control" name="codcli" value=" <%=codcli%>">
                                                        </div>
                                                        <div class="form-group col-md-3 ">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <input type="text" class="form-control" required name="contaccli" value=" <%=listado.getString("contaccli")%>">
                                                        </div>
