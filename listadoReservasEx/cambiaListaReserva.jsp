...
// Execute query... 
    String buscar = "SELECT codres, nomcli, apecli, nomapto, nomage, fechaent, fechasal, numper, observaciones FROM agencia ag JOIN reserva r ON (ag.codage=r.codage) JOIN cliente c ON (c.codcli=r.codcli) JOIN apartamento ap ON (ap.codapto=r.codapto) WHERE codres = '" + codres + "'";
                                        ...
                                        <div class="table-wrapper">
                                            <div class="table-title">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <form action="buscaListaReservas.jsp" method="GET"> 
                                                        ...
                                                        <div class="form-group col-md-3 ">
                                                            ...
                                                            <input type="text" class="form-control" required name="nomcli" value="<%=listado.getString("nomcli")%>">
                                                        </div>
                                                        <div class="form-group col-md-3 ">
                                                            <label>Apellido Cliente</label>
                                                            <input type="text" class="form-control" required name="apecli" value="<%=listado.getString("apecli")%>">
                                                        </div>

                                                        <div class="form-group col-md-3">
                                                            <label>Apartamento</label>

                                                            <select class="form-control" required name="nomapto" id="nomapto">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <select class="form-control" required name="nomage" id="nomage">
                                                        ...
                                                        <div class="form-group col-md-3 ">
                                                            <label>Entrada</label>
                                                            <input type="text" class="form-control" required name="fechaent" value="<%=listado.getString("fechaent")%>">
                                                        </div>
                                                        <div class="form-group col-md-3 ">
                                                            <label>Salida</label>
                                                            <input type="text" class="form-control" required name="fechasal" value="<%=listado.getString("fechasal")%>">
                                                        </div>
                                                        <div class="form-group col-md-3 ">
