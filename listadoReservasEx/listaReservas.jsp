                ...
                <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                    ...
                    <div class="navi">
                        <ul>
                            ...
                            <li><a href="../reservas/reservas.jsp"><i class="fa fa-database" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Listado Reservas</span></a></li>
                            <li><a href="../listadoReservasEx/listaReservas.jsp"><i class="fa fa-suitcase" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Entradas</span></a></li>
                        </ul>
                    </div>
                </div>
                                            ...
                                            <div class="table-title">
                                                    ...
                                                    <table class="table table-striped table-hover">
                                                        ...
                                                        <tbody>     
                                                            ...
                                                            <%    Class.forName("com.mysql.jdbc.Driver");
                                                                ...
                                                                ResultSet listado = s.executeQuery("SELECT codres, nomcli, apecli, nomapto, nomage, fechaent, fechasal, numper, observaciones FROM agencia ag join reserva r ON (ag.codage=r.codage) JOIN cliente c ON (c.codcli=r.codcli) JOIN apartamento ap ON (ap.codapto=r.codapto) ORDER BY codres");
                                                ...
                                                /*                ArrayList<String> nomage = new ArrayList<String>();
                                                                ...
                                                                for (int i = 0; i < codage.size(); i++) {
                                                                    System.out.print(codage.get(i) + " ");
                                                                    System.out.println(nomage.get(i));
                                                                ...
                                                                while (listado.next()) {
                                                                    ...
                                                                    out.print("</td>");
                                                                    out.print("<td>");
                                                                    out.println(listado.getString("nomage"));
                                                                    out.print("</td>");
                                                                    out.print("<td>");
