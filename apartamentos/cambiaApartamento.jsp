...
// Execute query... 
    String buscar = "SELECT * FROM apartamento WHERE codapto = '" + codapto + "'";
                ...
                <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                    ...
                    <div class="navi">
                        <ul>
                            ...
                            <li><a href="altaApartamento.html"><i class="fa fa-plus" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Crear Apartamento</span></a></li>
                            <li><a href="apartamento.jsp"><i class="fa fa-database" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Listado Apartamentos</span></a></li>
                        </ul>
                    </div>
                </div>
                                        ...
                                        <div class="table-wrapper">
                                            <div class="table-title">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <form action="buscaCambiaApartamento.jsp" method="GET"> 
                                                        <div class="form-group col-md-3 ">
                                                            <label>Código Apartamento</label>
                                                            <input type="text" class="form-control" disabled  value=" <%=codapto%>">
                                                            <input type="hidden" class="form-control" name="codapto" value=" <%=codapto%>">
                                                        </div>
                                                        <div class="form-group col-md-3 ">
                                                            <label>Nombre Apartamento</label>
                                                            <input type="text" class="form-control" required name="nomapto" value="<%=listado.getString("nomapto")%>">
                                                        </div>
                                                        <div class="col-md-1">
                                                            <label>Acción</label>
