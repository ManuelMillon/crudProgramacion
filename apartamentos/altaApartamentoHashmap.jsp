        ...
        <div class="container-fluid display-table">
            <div class="row display-table-row">
                <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                    <div class="logo">
                        <a hef="home.html"><img src="../imagenes/imagenCorporativa1.jpg" alt="merkery_logo"
                    ...
                    <div class="navi">
                        <ul>
                            <li class="active"><a href="../index.html"><i class="fa fa-home" aria-hidden="true"></i><span
                                        class="hidden-xs hidden-sm">Inicio</span></a></li>
                            <li><a href="#"><i class="fa fa-plus" aria-hidden="true"></i>
                                    <span class="hidden-xs hidden-sm">Crear Agencia</span></a></li>

                            <li><a href="#"><i class="fa fa-edit" aria-hidden="true"></i><span
                                        class="hidden-xs hidden-sm">Modificar Agencia</span></a></li>
                            <li><a href="#"><i class="fa fa-trash" aria-hidden="true"></i><span
                                        class="hidden-xs hidden-sm">Borrar Agencia</span></a></li>
                        </ul>
                    </div>
                </div>
