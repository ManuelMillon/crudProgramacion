                                                    ...
                                                    <tbody>     
                                                        ...
                                                        <%    Class.forName("com.mysql.jdbc.Driver");
                                                            ...
                                                            while (listado.next()) {
                                                                ...
                                                                out.print("<td>");
                                                        %> 
                                                    <a href="cambiaReserva.jsp?codres=<%= listado.getString("codres")%>"><i class="fa fa-edit"></i></a>
                                                        <%
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                        %> 

                                                    <a href="bajaReserva.jsp?codres=<%= listado.getString("codres")%>"><i class="fa fa-trash" onclick="myFunction()"></i></a>
