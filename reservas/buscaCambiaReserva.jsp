...
// Execute query... 
    String actualiza = "UPDATE reserva SET codres= ('" + codres + "'),fechaent= ('" + fechaent + "'),fechasal=('" + fechasal + "'), numper= ('" + numper + "'),codapto= ('" + codapto + "'),codcli=('" + codcli + "'), codage= ('" + codage + "'),observaciones=('" + observaciones + "') WHERE codres = ('" + codres + "')";
