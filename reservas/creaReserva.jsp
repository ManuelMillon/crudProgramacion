                                            ...
                                            <div class="table-title">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <form action="altaReserva.jsp" method="GET"> 

                                                            <div class="form-group col-md-4 ">
                                                                <label>Codigo Cliente</label>
                                                                <input type="text" class="form-control" required name="codcli">
                                                            </div>
                                                            <div class="form-group col-md-4 ">
                                                                <label>Código Apartamento</label>
                                                                <input type="text" class="form-control" required name="codapto">
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select class="form-control" name="codage" id="codage">
                                                                    ...
                                                                    <option value ="-30">Elije una opción</option>
                                                            ...
                                                            <div class="form-group col-md-4 ">
                                                                ...
                                                                <input type="text" class="form-control" required name="fechaent">
                                                            </div>
                                                            <div class="form-group col-md-4">
                                                                <label>Fecha Salida</label>
                                                                <input type="text" class="form-control" required name="fechasal">
                                                            </div>
                                                            <div class="form-group col-md-4">
                                                                <label>Número De Personas</label>
                                                                <input type="text" class="form-control" required name="numper">
                                                            </div>
                                                            <div class="form-group col-mx-auto">
                                                                <label for="exampleFormControlTextarea1">Observaciones</label>
                                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" input type="text" class="form-control" required name="observaciones"></textarea>
                                                            </div>
                                                    </div>
